 ...
 * @author srivi
 */
public class EventCreationJFrame extends javax.swing.JFrame {

    Connection connection;
    CityDirectory citydir;
    CensorBoardDirectory companysDirectory;
    String currentUser;

    public EventCreationJFrame(Connection connection, String user, CensorBoardDirectory cenDir, CityDirectory citydir) {
        initComponents();
        this.connection = connection;
        this.currentUser = user;
        this.companysDirectory = cenDir;
    ...
    private void populateApplications() {
        ...
        try {
            ResultSet rs = companysDirectory.getApplicationsByAsignee(currentUser);
            model.setRowCount(0);
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        OrganizerFld = new javax.swing.JTextField();
        SponsorFld = new javax.swing.JTextField();
        UrlFld = new javax.swing.JTextField();
        VenuesDropDown = new javax.swing.JComboBox<>();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/icons8-logout-rounded-50.png"))); // NOI18N
        ...
        ApplicationsTableData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Application Id", "Venue", "Name", "Event Organizer", "Sponsor", "Applied Date", "Application Status", "Event Status", "Url"
            }
        ) {
        ...
        getContentPane().add(OrganizerFld, new org.netbeans.lib.awtextra.AbsoluteConstraints(515, 383, 308, 41));
        getContentPane().add(SponsorFld, new org.netbeans.lib.awtextra.AbsoluteConstraints(515, 442, 308, 41));
        getContentPane().add(UrlFld, new org.netbeans.lib.awtextra.AbsoluteConstraints(515, 501, 308, 41));

        VenuesDropDown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select" }));
        getContentPane().add(VenuesDropDown, new org.netbeans.lib.awtextra.AbsoluteConstraints(515, 560, 308, 49));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/511033.jpg"))); // NOI18N
        jLabel3.setText("jLabel3");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -2, 1310, 700));

        pack();
    }// </editor-fold>//GEN-END:initComponents
String name, dir, prod, url, venue, applied_date;
    private void SaveFldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveFldActionPerformed
        ...
        dir = OrganizerFld.getText();
        prod = SponsorFld.getText();
        url = UrlFld.getText();
        venue = String.valueOf(VenuesDropDown.getSelectedItem());
        String asignee = "" + currentUser;
        Date dNow = new Date();
        SimpleDateFormat ft
                = new SimpleDateFormat(" yyyy-MM-dd");
        String applied_date = ft.format(dNow);
        System.out.println(name);
        companysDirectory.insertRecord(name, dir, prod, url, venue, applied_date, asignee);
        populateApplications();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EventCreationJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EventCreationJFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField OrganizerFld;
    private javax.swing.JButton SaveFld;
    private javax.swing.JTextField SponsorFld;
    private javax.swing.JTextField UrlFld;
    private javax.swing.JLabel UsernameLbl;
    private javax.swing.JComboBox<String> VenuesDropDown;
