 ...
 */
public class UserMapJFrame extends javax.swing.JFrame {

    /**
     * Creates new form UserMapJFrame
     */
    Connection connection;
    String currentUser;
    private static final int MINIMUM_ZOOMING_VALUE = 0;
    private static final int MAXIMUM_ZOOMING_VALUE = 21;
    private static int zoomInValue = 5;

    public UserMapJFrame(Connection connection, String name) {
        initComponents();
    ...
    private void getMarkers() {
        ...
        try {
            ...
            while (rs2.next()) {
                stringValue += "[" + "'" + rs2.getString("message") + " " + rs2.getString("enterprise") + "'" + "," + rs2.getString("lat") + "," + rs2.getString("lon") + ",4],\n";
            }
    ...
    private void open_site() {
        ...
        String setMarkerScript = first + stringValue + third + fourth;
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            ZoomIN.addActionListener(e -> {
                if (zoomInValue < MAXIMUM_ZOOMING_VALUE) {
                    browser.mainFrame().ifPresent(frame
            ...
            ZoomOut.addActionListener(e -> {
                if (zoomInValue > MINIMUM_ZOOMING_VALUE) {
                    browser.mainFrame().ifPresent(frame
                            -> frame.executeJavaScript("map.setZoom("
                                    + --zoomInValue + ")"));
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserMapJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserMapJFrame().setVisible(true);
            }
        });
    }
