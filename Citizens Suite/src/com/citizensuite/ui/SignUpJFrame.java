...
import com.citizensuite.commonUtil.*;
...
public class SignUpJFrame extends javax.swing.JFrame {
    ...
    public boolean validEmail(String email) {
        return Pattern.compile(validationRegexPattern)
                .matcher(email)
                .matches();
    }
    ...
    String validationRegexPattern = "^(?=.{1,64}@)[A-Za-z0-9_-]+(\\.[A-Za-z0-9_-]+)*@"
    ...
    private void initComponents() {
        ...
        HomeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/home_24px.png"))); // NOI18N
        ...
        EmailGreenTick.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/icons8-approval-25.png"))); // NOI18N
        ...
        EmailRedTick.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/icons8-cross-mark-25.png"))); // NOI18N
        jPanel1.add(EmailRedTick, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 212, -1, -1));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/511033.jpg"))); // NOI18N
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 660, 560));
    ...
    private void HomeButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_HomeButtonMouseClicked
        ...
        dispose();
        // TODO add your handling verificationCode here:
    ...
    String firstName, lastName, userName, emailAddress, currentPass, confirmCurrentPasswoed, verificationCode;
    private void SignUpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpButtonActionPerformed
        firstName = FirstNameFld.getText();
        lastName = LastNameFld.getText();
        userName = UsernameFld.getText();
        emailAddress = EmailFld.getText();
        currentPass = CommonUtil.getHashedString(String.valueOf(PasswordFld.getPassword()));
        confirmCurrentPasswoed = String.valueOf(CnfPasswordFld.getPassword());
        ...
        try {
            ...
            st.setString(5, currentPass);
            st.setString(6, verificationCode);
            st.setString(7, "0");
            st.setString(8, "User");
            st.setDouble(9, 0.0);
            st.executeUpdate();
            send_mail(emailAddress, Integer.parseInt(verificationCode));
    ...
    private void VerifyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VerifyButtonActionPerformed
        ...
        try {
            ...
            if (codes.equals(verificationCode)) {
    ...
    public static void main(String args[]) {
        ...
        //<editor-fold defaultstate="collapsed" desc=" Look and feel setting verificationCode (optional) ">
