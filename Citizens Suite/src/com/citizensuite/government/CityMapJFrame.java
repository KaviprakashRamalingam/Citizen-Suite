 ...
 */
public class CityMapJFrame extends javax.swing.JFrame {

    String cordinates;
    Browser browserObj;

    public CityMapJFrame(String cord) {
        initComponents();
        this.cordinates = cord;
        open_site();
    }

    private CityMapJFrame() {
    ...
    private void open_site() {
        try {
            ...
            browserObj = engine.newBrowser();
            BrowserView view = BrowserView.newInstance(browserObj);
            browserObj.navigation().loadUrl("https://www.google.com/maps/@" + cordinates + ",21z");
            MapsPanel.add(view);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CityMapJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CityMapJFrame().setVisible(true);
            }
        });
    }
