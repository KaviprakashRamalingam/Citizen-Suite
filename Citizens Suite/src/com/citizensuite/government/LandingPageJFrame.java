...
public class LandingPageJFrame extends javax.swing.JFrame {
    ...
    public LandingPageJFrame(CensorBoardDirectory cenDir, String user, CityDirectory cityDir, EducationInstituteDirectory edudir) {
        initComponents();
        this.censorBoardDirectory = cenDir;
        this.currentUser = user;
        this.cityDirectory = cityDir;
        this.educationInstituteDirectory = edudir;
        GAdminTabbedPane.add("Censor Applications", new CensorJPanel(cenDir, user));
        GAdminTabbedPane.add("City  Applications", new CityPlannigJPanel(user, cityDir));
        GAdminTabbedPane.add("Course  Applications", new CourseJPanel(edudir));
        GAdminTabbedPane.add("Analytics", new AnalyticsJPanel(cityDir, cenDir, edudir));

    }

    private LandingPageJFrame() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 30, 230, -1));
