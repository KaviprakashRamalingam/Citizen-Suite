 ...
 */
public class CityCommisionerJFrame extends javax.swing.JFrame {

    Connection connection;
    CityDirectory cityDirectory;
    String currentUser;

    public CityCommisionerJFrame(Connection connection, String user, CityDirectory cityDir) {
        initComponents();
    ...
    private void populateApplications() {
        ...
        try {
            ResultSet rs = cityDirectory.getAllApplications();
            model.setRowCount(0);
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/city.png"))); // NOI18N
    ...
    private void UpdateStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateStatusActionPerformed
        ...
        cityDirectory.UpdateStatus(id, stat);
    ...
    private void ViewonMapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewonMapActionPerformed
        ...
        CityMapJFrame frame = new CityMapJFrame(cord);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CityCommisionerJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new CityCommisionerJFrame().setVisible(true);
        });
    }
