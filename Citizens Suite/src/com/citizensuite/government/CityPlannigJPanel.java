 ...
 */
public class CityPlannigJPanel extends javax.swing.JPanel {

    String currentUser;
    CityDirectory cityDirectory;

    public CityPlannigJPanel(String user, CityDirectory cityDir) {
        initComponents();
    ...
    private void populateAsignees(String role) {
        ...
        try {
            ResultSet rs = cityDirectory.getUserData();
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        tasignee.setText("Load Venue Data");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/city plan.jpg"))); // NOI18N
    ...
    private void tasigneeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tasigneeMouseClicked
        populateApplicationsByType("venue");
