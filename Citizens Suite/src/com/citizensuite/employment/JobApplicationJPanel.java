 ...
 * @author srivi
 */
public class JobApplicationJPanel extends javax.swing.JPanel {

    Connection connection;
    String currentUser;
    CompanysDirectory companysDirectory;

    public JobApplicationJPanel(CompanysDirectory compDir, Connection connection, String user) {
        initComponents();
    ...
    private void populateJobs() {
        ...
        try {
            ResultSet rs = companysDirectory.get_company_applications(currentUser);
            model.setRowCount(0);
    ...
    private void populateCompanies() {
        ...
        try {
            ResultSet compData;
            compData = companysDirectory.getCompanies();
            while (compData.next()) {
    ...
    private void initComponents() {
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, 760, -1));

        ApplicationsTable.setBackground(new java.awt.Color(204, 204, 204));
        ...
        add(CompaniesDropDown, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 110, 264, 38));

        jLabel1.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 255));
        jLabel1.setText("Company :");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 90, 140, 70));
        ...
        add(JobsDropDown, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 190, 264, 38));

        jLabel3.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 255));
        jLabel3.setText("Jobs :");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 190, 90, 40));
        ...
        BackgroundIMage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/employs2.jpeg"))); // NOI18N
        add(BackgroundIMage, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -20, 1140, 580));
    ...
    private void CompaniesDropDownActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CompaniesDropDownActionPerformed
        ...
        try {
            ResultSet compData = companysDirectory.getJobs(company);
            while (compData.next()) {
        ...
        try {
            ResultSet rs = companysDirectory.getCord(company);
            if (rs.next()) {
    ...
    private void ApplyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ApplyButtonActionPerformed
        ...
        companysDirectory.newApplicationToCompany(currentUser, comp, job);
        companysDirectory.insert_purchase_university(currentUser, comp, lat, lon, "Applied at ");
