...
public class CreateUniversityPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        universitydropdown.setBackground(new java.awt.Color(204, 204, 204));
        ...
        deanfld.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/pencil.jpeg"))); // NOI18N
...
String name, dean, location, cord;
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        ...
        cityDirectory.addUniversityBySystemAdmin(name, dean, location, userCoordinates.getLat(), userCoordinates.getLon());
