...
public class CreateUniversityCoursesJPanel extends javax.swing.JPanel {

    Connection connection;
    CityDirectory cityDirectory;
    EducationInstituteDirectory educationInstituteDirectory;

    public CreateUniversityCoursesJPanel(Connection connection, EducationInstituteDirectory edudir, CityDirectory citydir) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/frame.jpeg"))); // NOI18N
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        ...
        educationInstituteDirectory.AddCourseByAdmin(university, name, professor, dayOfWeek, selectedFileUrl, applied_date);
...
// TODO add your handling code here:
    ...
    String university, name, professor, dayOfWeek, selectedFileUrl;
