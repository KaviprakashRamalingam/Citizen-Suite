...
public class CreateAdminsJPanel extends javax.swing.JPanel {

    Connection connection;
    UserAccountDirectory userAccountDirectory;
    String firstName, lastName, userName, emailAddress, userRoleType, currentPassword, confirmCurrentPassword;

    public CreateAdminsJPanel(Connection connection, UserAccountDirectory userDir) {
        initComponents();
    ...
    private void populateAdmins() {
        ...
        try {
            ResultSet rs = userAccountDirectory.getAdminsData();
            model.setRowCount(0);
    ...
    private void initComponents() {
        ...
        UserData.setBackground(new java.awt.Color(204, 204, 204));
        ...
        rolefld.setBackground(new java.awt.Color(204, 204, 204));
        rolefld.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "eventcreator", "venuecreator", "ucreator", "ccreator", "compcreator", "jobscreator", "gadmin", "censoradmin", "citycomm", "coursecreator", "courseregadmin", " " }));
        ...
        cnfpassword.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/1.jpg"))); // NOI18N
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -60, 1200, 630));
    ...
    private void CreateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateButtonActionPerformed
        ...
        userRoleType = rolefld.getSelectedItem().toString();
        currentPassword = String.valueOf(password.getPassword());
        confirmCurrentPassword = String.valueOf(cnfpassword.getPassword());
        userAccountDirectory.addAdmin(firstName, lastName, userName, currentPassword, emailAddress, userRoleType);
