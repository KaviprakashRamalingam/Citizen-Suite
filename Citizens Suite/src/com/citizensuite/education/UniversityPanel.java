...
public class UniversityPanel extends javax.swing.JPanel {
    ...
    public UniversityPanel(EducationInstituteDirectory edudir, String user) {
        initComponents();
    ...
    private void populateApplications() {
        ...
        try {
            ResultSet rs = educationInstituteDirectory.get_university_applications(currentUser);
            model.setRowCount(0);
    ...
    private void populateCourses(String uni) {
        ...
        try {
            ResultSet rs = educationInstituteDirectory.getCourses(uni);
            while (rs.next()) {
    ...
    private void populateUniversities() {
        ...
        try {
            ResultSet rs = educationInstituteDirectory.getUniversities();
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/university.jpeg"))); // NOI18N
        jLabel4.setText("jLabel4");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1130, 630));
...
double lat, lon;
    private void ApplyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ApplyButtonActionPerformed
        ...
        educationInstituteDirectory.insert_university_application(uni, course, currentUser);
        educationInstituteDirectory.insert_purchase_university(currentUser, uni, lat, lon, "Applied at ");
    ...
    private void UniversityDropDownActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UniversityDropDownActionPerformed
        ...
        populateCourses(uni);
        try {
            ResultSet rs = educationInstituteDirectory.getCord(uni);
            if (rs.next()) {
    ...
    private void WithdrawButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_WithdrawButtonActionPerformed
        String uni = String.valueOf(UniversityDropDown.getSelectedItem());
        String course = String.valueOf(CourseDropDown.getSelectedItem());
        String path = educationInstituteDirectory.getCourseFile(course, uni);
        try {
