...
public class CourseCreatorFrame extends javax.swing.JFrame {
    ...
    public CourseCreatorFrame(String user, EducationInstituteDirectory edudir, CityDirectory citydir) {
        initComponents();
    ...
    private void initComponents() {
        ...
        unidropdown.setBackground(new java.awt.Color(204, 204, 204));
        ...
        proffld.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/icons8-repeat-25.png"))); // NOI18N
        ...
        dowfld.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/citizensuite/assets/icons8-logout-50.png"))); // NOI18N
    ...
    String university, courseName, professor, dayOfWeek, selectedFileUrl;
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        university = String.valueOf(unidropdown.getSelectedItem());
        courseName = namefld.getText();
        professor = proffld.getText();
        dayOfWeek = String.valueOf(dowfld.getSelectedItem());
        selectedFileUrl = filelbl.getText();
        java.util.Date dNow = new java.util.Date();
        SimpleDateFormat ft
                = new SimpleDateFormat(" yyyy-MM-dd");
        String applied_date = ft.format(dNow);
        educationInstituteDirectory.AddCourse(university, courseName, professor, dayOfWeek, selectedFileUrl, applied_date, currentUser);
    ...
    private void populateApplications() {
        ...
        try {
            ResultSet rs = educationInstituteDirectory.getCoursesByAsignee(currentUser);
            model.setRowCount(0);
            while (rs.next()) {
